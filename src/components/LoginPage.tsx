...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
  ...
  const demoCredentials = [
    ...
    { email: "Forgelabstudio25@gmail.com", role: "Admin" },
  ];
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-light-green focus:border-transparent transition-all duration-300 bg-white"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-12 pr-12 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-light-green focus:border-transparent transition-all duration-300 bg-white"
