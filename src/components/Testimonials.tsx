...
const Testimonials = () => {
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "Forge Lab Studios brought fresh energy to our seasonal campaigns. Their creative direction led to a 200% spike in digital engagement across platforms. A phenomenal team!",
      image:
    ...
    },
    {
      ...
      rating: 5,
      text: "Forge Lab Studios helped us craft a launch video that went viral. It reached over 1.8 million South Africans in the first week and drove a record number of app downloads.",
      image:
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-dark-grey to-dark-green relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative max-w-5xl mx-auto">
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 lg:p-16 animate-slide-up border border-white/20">
