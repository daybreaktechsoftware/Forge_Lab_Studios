      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
              ...
              <button
                ...
                className={`px-8 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 ${
                  selectedCategory === category.id
                    ...
                    : "bg-white text-gray-600 hover:bg-light-green hover:text-white shadow-md border border-gray-200"
                }`}
              >
                {category.name}
              </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            <div
              key={project.id}
              className="group relative overflow-hidden rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer animate-slide-up bg-white border border-gray-100 hover:border-light-green/20"
        ...
        <div className="fixed inset-0 bg-black/90 backdrop-blur-sm z-50 flex items-center justify-center p-6">
          <div className="relative max-w-4xl w-full bg-white rounded-3xl overflow-hidden shadow-2xl">
            <button
              ...
              className="absolute top-6 right-6 text-gray-400 hover:text-gray-600 transition-colors z-10 bg-white/80 backdrop-blur-sm p-2 rounded-full"
            >
              <X className="h-6 w-6" />
            </button>
