            ...
            <div className="space-y-6">
              {upcomingSchedule.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-light-green/20 hover:-translate-y-1"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {pastSchedule.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className="bg-white/60 rounded-3xl p-6 shadow-md border border-gray-100 opacity-75"
                  >
